...
import email from '@/assets/images/Service/email1.png';

import { AnimatePresence, motion } from 'framer-motion';

export default function ServicePage() {
  return (
    <div className="flex flex-col items-center w-screen h-full min-h-screen relative bg-linear-gradient p-24">
      <img src={jelly1} className="absolute -top-0 left-2 w-60 h-40 scale-90 " />
      <img src={jelly2} className="absolute top-2 transition-transform right-8 w-52 h-24 scale-125" />
      <img src={jelly3} className="absolute top-[30%] left-4 scale-90" />
      <img src={jelly4} className="absolute top-[25%] right-2 w-40 scale-90" />
      <img src={jelly5} className="absolute bottom-[25%] left-12 w-32" />
      <img src={jelly6} className="absolute bottom-[27%] right-8 w-28" />

      <AnimatePresence>
        <motion.div
          className="flex flex-col items-center text-white text-[3rem] font-[LM] mb-4"
      ...
      <motion.div
        className="felx text-[#6896ff] text-2xl font-[LM]"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex justify-around items-center bg-[#FCFCFC] bg-opacity-40 shadow-[3px_4px_4px_1px_rgba(0,0,0,0.20)] rounded-[1.5rem] px-4 w-[480px] h-[200px]">
            <div className="flex flex-col">
              <p className="text-[#000000] font-[LM] text-3xl mb-1">내가 만든 동화를 영어로</p>
              <br />
          ...
          <div className="flex justify-around items-center bg-[#FCFCFC] bg-opacity-40 shadow-[3px_4px_4px_1px_rgba(0,0,0,0.20)] rounded-[1.5rem] px-4 w-[480px] h-[200px]">
            <div className="flex flex-col">
              <p className="text-[#000000] font-[LM] text-3xl mb-1">오디오북 지원</p>
              <br />
      ...
      <AnimatePresence>
        ...
        >
          <div className="flex justify-around items-center bg-[#FCFCFC] bg-opacity-40 shadow-[3px_4px_4px_1px_rgba(0,0,0,0.20)] rounded-[1.5rem] px-4 w-[480px] h-[200px]">
            <div className="flex flex-col">
              <p className="text-[#000000] font-[LM] text-3xl mb-1">그림 생성 AI</p>
              <br />
