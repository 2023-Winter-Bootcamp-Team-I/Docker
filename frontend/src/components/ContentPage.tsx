...
const ContentPage = React.forwardRef(({ pageData }: ContentPageProps) => {
  ...
  return (
    <div className="flex justify-center items-center flex-col px-[2.5rem] py-8 h-[700px] bg-[#93C4FF] border-[#7bb6ff] border-y-4 border-l-4 border-solid rounded-2xl">
      <div className="flex flex-col items-center justify-around box-border px-2 w-full h-[100%] bg-white bg-opacity-45  rounded-2xl z-30">
